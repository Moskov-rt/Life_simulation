...
// Update the resignation clearing logic:
code = code.replace(
  "adultPerformerCareer: gameState.adultPerformerCareer?.active ? { ...gameState.adultPerformerCareer, active: false, yearlyActions: emptyAdultActions() } : gameState.adultPerformerCareer,",
  "adultPerformerCareer: gameState.adultPerformerCareer?.active ? { ...gameState.adultPerformerCareer, active: false, yearlyActions: emptyAdultActions() } : gameState.adultPerformerCareer,\n      actorCareer: gameState.actorCareer?.active ? { ...gameState.actorCareer, active: false, actions: emptyActorActions() } : gameState.actorCareer,"
);
